...
public class TextureRedrawer {
    ...
    public static const OUTLINE_FILTER:GlowFilter = new GlowFilter(0.5, 1.8, 2.9, 3.1, 0xFF, BitmapFilterQuality.LOW, false, false);
    ...
    public static function redraw(_arg_1:BitmapData, _arg_2:int, _arg_3:Boolean, _arg_4:uint, _arg_5:Boolean = true, _arg_6:Number = 5):BitmapData {
        ...
        _local_8 = GlowRedrawer.outlineGlow(_local_8, _arg_4, 2.8 , _arg_5);
        if (_arg_5) {

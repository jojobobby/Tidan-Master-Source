...
public class EquipmentToolTip extends ToolTip {
    ...
    private function makeItemPowerText():void {
        var _local_1:int;
        if (this.objectXML.hasOwnProperty("BADfeedPowerBAD")) {
            _local_1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFFFF : 16549442);
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("Power Level: " + this.objectXML.feedPower)));
            this.powerText.filters = [new DropShadowFilter(0, 0, 0, 0.5, 12, 12)];
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
        if (this.objectXML.hasOwnProperty("HalfHPBerserk")) {
            _local_1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFF00 : 16549442);
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("Strength: When equipped you get a Berserk buff at 1/2 of your health.")));
            this.powerText.filters = [new DropShadowFilter(0, 0, 0, 0.5, 12, 12)];
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
        if (this.objectXML.hasOwnProperty("TeleportLowHp")) {
            _local_1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFF00 : 16549442);
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("Flash: When this item is equipped you gain damaging for 5 seconds if you teleport under half hp.")));
            this.powerText.filters = [new DropShadowFilter(0, 0, 0, 0.5, 12, 12)];
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
        if (this.objectXML.hasOwnProperty("Resurrects")) {
            _local_1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFF00 : 16549442);
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("Undying: When equipped you Resurrect after death.")));
            this.powerText.filters = [new DropShadowFilter(0, 0, 0, 0.5, 12, 12)];
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
        if (this.objectXML.hasOwnProperty("HalfHPArmored")) {
            _local_1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFF00 : 16549442);
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("Fortify: When equipped you get a armored buff at 1/3 of your health.")));
            this.powerText.filters = [new DropShadowFilter(0, 0, 0, 0.5, 12, 12)];
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
        if (this.objectXML.hasOwnProperty("HPabovehalf")) {
            _local_1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFF00 : 16549442);
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("Alive: When equipped you get a insane dex boost if health is at 95% or higher.")));
            this.powerText.filters = [new DropShadowFilter(0, 0, 0, 0.5, 12, 12)];
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
        if (this.objectXML.hasOwnProperty("MPabovehalf")) {
            _local_1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFF00 : 16549442);
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("Knowledge: When equipped you get a Vit boost if your Mana is 50% or higher.")));
            this.powerText.filters = [new DropShadowFilter(0, 0, 0, 0.5, 12, 12)];
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
        if (this.objectXML.hasOwnProperty("NearbyDefBoost")) {
            _local_1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFF00 : 16549442);
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("Guard: When this item is equipped you gain 1 extra defense for each enemy around you.")));
            this.powerText.filters = [new DropShadowFilter(0, 0, 0, 0.5, 12, 12)];
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
        if (this.objectXML.hasOwnProperty("HalfMPAImmune")) {
            _local_1 = ((((this.playerCanUse) || ((this.player == null)))) ? 0xFFFF00 : 16549442);
            this.powerText = new TextFieldDisplayConcrete().setSize(12).setColor(_local_1).setBold(true).setTextWidth((((MAX_WIDTH - this.icon.width) - 4) + 14)).setWordWrap(true);
            this.powerText.setStringBuilder(new StaticStringBuilder().setString(("MagicBarrier: When equipped you're immune to Armor Break if mp is 1/2 full.")));
            this.powerText.filters = [new DropShadowFilter(0, 0, 0, 0.5, 12, 12)];
            waiter.push(this.powerText.textChanged);
            addChild(this.powerText);
        }
        ...
        if (((((_local_1) && (_local_2))) && (_local_3))) {
            ...
            if (_local_4) {
                ...
                if (this.objectXML.hasOwnProperty("LG")) {
                    ...
                    this.tierText.setStringBuilder(new LineBuilder().setParams("LG"));
                }
                else if (this.objectXML.hasOwnProperty("@setType")) {
                    this.tierText.setColor(0xFFA500);
                    this.tierText.setStringBuilder(new StaticStringBuilder("ST"));
                }
                else {
                    this.tierText.setColor(0x8A2BE2);
                    this.tierText.setStringBuilder(new LineBuilder().setParams("UT"));
                }
            }
    ...
    private function makeRestrictionList():void
    {
        ...
        if (this.objectXML.hasOwnProperty("LG1"))
        {
            this.restrictions.push(new Restriction(("Items that are stronger than UT"), 0xFFFF00, false));
        }

        if (this.objectXML.hasOwnProperty("Soulbound"))
        {
            this.restrictions.push(new Restriction(TextKey.ITEM_SOULBOUND, 0x8A2BE2, false));
        }
        ...
        if (this.objectXML.hasOwnProperty("DefAbility"))
        {
            this.restrictions.push(new Restriction("Defense: Uses defense to improve the ability.", 0x8A2BE2, false));
        }
    }
    ...
    private function handleDefMod():void {
        var _local_3:XML;
        var _local_4:XML;
        var _local_5:String;
        var _local_6:String;
        ...
        var _local_1:Number = (this.player.defense_ + this.player.defenseBoost_);
        if (_local_1 < 25) {
            return;
        }
        var _local_2:Vector.<XML> = new Vector.<XML>();
        ...
        for each (_local_4 in _local_2) {
            for each (_local_3 in _local_4.Activate) {
                _local_5 = _local_3.toString();
                if (_local_3.@effect != "Stasis") {
                    _local_6 = _local_3.@useDefMod;
                    if (!(((((((_local_6 == "")) || ((_local_6 == "false")))) || ((_local_6 == "0")))) || ((_local_3.@effect == "Stasis")))) {
                        switch (_local_5) {
                            case ActivationType.HEAL_NOVA:
                                _local_3.@amount = this.modifyDefModStat(_local_3.@amount, 0);
                                _local_3.@range = this.modifyDefModStat(_local_3.@range);
                                break;
                            case ActivationType.COND_EFFECT_AURA:
                                _local_3.@duration = this.modifyDefModStat(_local_3.@duration);
                                _local_3.@range = this.modifyDefModStat(_local_3.@range);
                                break;
                            case ActivationType.COND_EFFECT_SELF:
                                _local_3.@duration = this.modifyDefModStat(_local_3.@duration);
    ...
    private function modifyDefModStat(_arg_1:String, _arg_2:Number = 1):String {
        var _local_5:Number;
        var _local_6:int;
        var _local_7:Number;
        var _local_3 = "-1";
        var _local_4:Number = (this.player.defense_ + this.player.defenseBoost_);
        if (_local_4 < 30) {
            _local_3 = _arg_1;
        }
        else {
